...
public class Services {
    ...
    static void init() {
        ...
        mainRouter.route("/*").handler(r->{
            r.response().headers().add("Access-Control-Allow-Headers" ,"access-control-allow-origin,origin, authorization, accept, content-type, x-requested-with,user,password,Content-Type,Origin,X-Requested-With")
